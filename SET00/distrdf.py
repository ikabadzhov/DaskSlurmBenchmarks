...
cluster = SLURMCluster(memory='{}g'.format(8*args.cores),
...
if __name__ == '__main__':
    filelist = ["input_files/dimuon/f{}.root".format(i) for i in range(1,366)]
    df = RDataFrame("Events", filelist, npartitions=(3072), daskclient=client)
